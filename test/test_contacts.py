...
class TestContacts:
    def test_add_contacts_positive(self, session, add_contact_url, auth_header, random_contact):
    ...
    def test_update_contact_negative(self, session, add_contact_url, auth_header, create_contact):
        contact_id = create_contact
    ...
    def test_update_contact_one_field_second_positive(self,
                                                      session, add_contact_url, auth_header,
